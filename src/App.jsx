		...
		<div className='flex justify-center md:my-24 md:items-center min-h-screen'>
			<div className='flex flex-col w-full md:w-132 md:rounded-xl md:p-4 bg-white'>
				<img
					...
					src={omelette}
					alt='Picture of omelette with spinach and seasoning'
				/>
				<div className='mx-8 mb-4 md:mx-2 md:mb-6'>
					<h1 className='text-left young-serif mb-4 text-4xl text-stone-900 md:text-xl'>
						Simple Omelette Recipe
					</h1>
					<p className='text-left outfit font-light m-auto text-stone-600 md:text-sm'>
				...
				<div className='bg-rose-50 mx-8 mb-4 py-4 pl-8 rounded-xl md:mx-2'>
					<h3 className='outfit text-rose-800 mb-4 text-lg md:text-sm'>
						Preparation time
					</h3>
				...
				<div class='mx-8 mb-4 md:mx-2'>
					<h2 class='young-serif brown text-2xl mb-4 md:text-lg'>
						Ingredients
					</h2>
					<ul class='px-4 outfit text-stone-600 md:text-sm'>
						...
						<li class='px-4 mb-2 custom-marker'>
				...
				<div class='mx-8 mb-4 md:mx-2'>
					...
					<ol class='pl-4 list-decimal outfit marker:font-bold text-stone-600 md:text-sm'>
						...
						<li class='px-4 mb-2 custom-marker'>
							<b>Heat the pan:</b> Place a non-stick frying pan over the medium
